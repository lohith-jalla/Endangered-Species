...
```sh
 git clone https://github.com/lohith-jalla/Endangered-Species.git
```
...
2. **Clone Your Forked Repository:**
    ...
    ```sh
     git clone https://github.com/<your_user_name>/Endangered-Species
    ```
...
3. **Add a reference(remote) to the original repository:**
    ...
    ```
    git remote add upstream https://github.com/lohith-jalla/Endangered-Species
    ```
...
2. **Clone the Repository:**
   - If you haven't cloned the Endangered-Species repository yet, you can do so by clicking on the "File" menu and selecting "Clone Repository."
   - Choose the Endangered-Species repository from the list of repositories on GitHub and clone it to your local machine.
...
7. **Create a Pull Request:**
  - Go to the GitHub website and navigate to your fork of the Endangered-Species repository.
